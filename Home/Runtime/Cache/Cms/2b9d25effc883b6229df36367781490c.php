...
<div class="main_content_left">
    ...
    <div class="article_cat_content">
        ...
        <?php if($col["cid"] == $current_head_navigation): ?><a href="__APP__/Cms/Article/column/cid/<?php echo ($col["cid"]); ?>" class="select"><?php echo ($col["cname"]); ?>&nbsp;&nbsp;&nbsp;<?php echo ($col["cname_en"]); ?></a>
        <?php else: ?>
        <a href="__APP__/Cms/Article/column/cid/<?php echo ($col["cid"]); ?>"><?php echo ($col["cname"]); ?>&nbsp;&nbsp;&nbsp;<?php echo ($col["cname_en"]); ?></a><?php endif; ?>
        </li>
...
<div class="main_content_right">
	<div class="nav_bread">
        ...
        <?php else: ?>
        <span>&gt;</span>
        <span><a href="__APP__/Cms/Article/column/cid/<?php echo ($col["cid"]); ?>"><?php echo ($col["cname"]); ?>&nbsp;<?php echo ($col["cname_en"]); ?></a></span><?php endif; endforeach; endif; else: echo "" ;endif; ?>
    </div>
    <div class="article_content">
        ...
        <div class="article_list">
            ...
            <div class="news_name"><a href="__APP__/Cms/Article/article/id/<?php echo ($art["aid"]); ?>" target="_blank"><?php echo ($art["title"]); ?></a></div>
            ...
            <div class="page_list">
                ...
                <a href='__APP__/Cms/Article/column/cid/<?php echo ($current_head_navigation); ?>/p/1'>首页</a>&nbsp;
                <a href='__APP__/Cms/Article/column/cid/<?php echo ($current_head_navigation); ?>/p/<?php echo ($page_code["page_prev"]); ?>'>前一页</a>&nbsp;
                <?php if(is_array($page_code["page_num"])): $i = 0; $__LIST__ = $page_code["page_num"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$num): $mod = ($i % 2 );++$i; if($page_code["page_current"] == $num): ?><a href='__APP__/Cms/Article/column/cid/<?php echo ($current_head_navigation); ?>/p/<?php echo ($num); ?>' class='current'><?php echo ($num); ?></a>&nbsp;
                <?php else: ?>
                <a href='__APP__/Cms/Article/column/cid/<?php echo ($current_head_navigation); ?>/p/<?php echo ($num); ?>'><?php echo ($num); ?></a>&nbsp;<?php endif; endforeach; endif; else: echo "" ;endif; ?>
                <a href='__APP__/Cms/Article/column/cid/<?php echo ($current_head_navigation); ?>/p/<?php echo ($page_code["page_next"]); ?>'>后一页</a>&nbsp;
                <a href='__APP__/Cms/Article/column/cid/<?php echo ($current_head_navigation); ?>/p/<?php echo ($page_code["page_total"]); ?>'>尾页</a>&nbsp;<?php endif; ?>
			</div>
			</div>
        </div>
    </div>
