...
<div class="main_content_left">
    ...
    <div class="article_cat_content">
        ...
        <?php if($col["cid"] == $nav_current_col_id): ?><a href="__APP__/Cms/Article/column/cid/<?php echo ($col["cid"]); ?>" class="select"><?php echo ($col["cname"]); ?></a>
        <?php else: ?>
        <a href="__APP__/Cms/Article/column/cid/<?php echo ($col["cid"]); ?>"><?php echo ($col["cname"]); ?></a><?php endif; ?>
        </li>
...
<div class="main_content_right">
    ...
    <div class="article_content">
        ...
        <div class="article_list">
            ...
            <div class="news_name"><a href="__APP__/Cms/Article/article/id/<?php echo ($art["aid"]); ?>"><?php echo ($art["title"]); ?></a></div>
