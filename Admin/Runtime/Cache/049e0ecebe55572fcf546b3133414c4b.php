...
<div class="content_table" style="border:1px solid #b8d0d6; padding:10px;">
    ...
    <?php if($wid > 0): ?><form name="contactForm" action="__APP__/Contact/update_contact" method="post">
    <?php else: ?>
    <form name="contactForm" action="__APP__/Contact/insert_contact" method="post"><?php endif; ?>
