...
<div class="menu_list">
    ...
    <ul>
    	<li><div class="node_bg1"></div><div class="node_bg2"></div><a href="__APP__/Cms/Column/col_add" target="content">新增栏目</a></li>
        <li><div class="node_bg1"></div><div class="node_bg2"></div><a href="__APP__/Cms/Column/col_list" target="content">栏目列表</a></li>
        <li><div class="node_bg1"></div><div class="node_bg2"></div><a href="__APP__/Cms/Article/article_add" target="content">添加文章</a></li>
        <li><div class="node_bg1"></div><div class="node_bg2"></div><a href="__APP__/Cms/Article/article_list" target="content">文章列表</a></li>
	</ul>
    </div>
    <div class="menu_head"><div class="menu_head_folder">&nbsp;</div><div class="menu_head_title">站点信息</div></div>
    <div class="menu_table">
    <ul>
    	<li><div class="node_bg1"></div><div class="node_bg2"></div><a href="__APP__/Siteinfo/Links/links_list" target="content">友情链接</a></li>
