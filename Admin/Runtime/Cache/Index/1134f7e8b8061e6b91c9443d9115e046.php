...
<form action="__APP__/Index/Index/login" name="loginForm" method="post">
...
<tr>
    ...
    <td><img id="verifyImg" src="__APP__/Index/Index/verify/" onclick="fleshVerify()" style="cursor:pointer" title="看不清？点击换一张！" /></td>
</tr>
...
function fleshVerify()
{
	...
	document.getElementById('verifyImg').src = "__APP__/Index/index/verify/" + time;
}
</script>
