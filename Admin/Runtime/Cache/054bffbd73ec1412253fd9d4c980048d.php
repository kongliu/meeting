...
<body>
<!-- <div class="content"><div class="content_title" style="border-bottom:1px solid #b8d0d6;">后台管理</div></div> -->
<div class="content">
<div class="content_title">栏目管理</div>
<div class="content_table" style="border:1px solid #b8d0d6; padding:10px;">

    <?php if($col_info["cid"] > 0): ?><form name="columnForm" action="__APP__/Column/col_update" method="post">
    <?php else: ?>
    <form name="columnForm" action="__APP__/Column/col_insert" method="post"><?php endif; ?>
