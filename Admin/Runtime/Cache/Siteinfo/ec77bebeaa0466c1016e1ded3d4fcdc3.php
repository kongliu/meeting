...
<div class="content_table" style="border:1px solid #b8d0d6; padding:10px;">
    ...
    <?php if(is_array($contact_list)): $i = 0; $__LIST__ = $contact_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$con): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td><a href="__APP__/Siteinfo/Contact/edit_contact/wid/<?php echo ($con["wid"]); ?>" >编辑</a>&nbsp;&nbsp;
        <a href="javascript:void(0)" onclick="del_con(<?php echo ($con["wid"]); ?>)">删除</a>&nbsp;&nbsp;
        <a href="__APP__/Siteinfo/Contact/add_contact" >添加</a></td>
	</tr><?php endforeach; endif; else: echo "" ;endif; ?>
	<?php else: ?>
    <tr><td height="25">还没有联系方式，要&nbsp;<a href="__APP__/Siteinfo/Contact/add_contact" >添加</a>&nbsp;吗？</td></tr><?php endif; ?> 
    </table>
	...
	function del_con(wid)
	{
		...
		{
			window.location.href = '__APP__/Siteinfo/Contact/del_contact/id/' + parseInt(wid);
		}
	}
	</script>
