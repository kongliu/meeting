...
<div class="content_table" style="border:1px solid #b8d0d6; padding:10px;">
    ...
    <?php if(is_array($friend_links_list)): $i = 0; $__LIST__ = $friend_links_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lin): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td><a href="__APP__/Siteinfo/Links/edit_link/lid/<?php echo ($lin["lid"]); ?>" >编辑</a>&nbsp;&nbsp;
        <a href="javascript:void(0)" onclick="del_lin(<?php echo ($lin["lid"]); ?>)">删除</a>&nbsp;&nbsp;
        <a href="__APP__/Siteinfo/Links/add_link" >添加</a></td>
	</tr><?php endforeach; endif; else: echo "" ;endif; ?>
    <?php else: ?>
    <tr><td height="25">还没有友情链接，要&nbsp;<a href="__APP__/Siteinfo/Links/add_link" >添加</a>&nbsp;吗？</td></tr><?php endif; ?>
    </table>
	...
	function del_lin(lid)
	{
		...
		{
			window.location.href = '__APP__/Siteinfo/Links/del_link/id/' + parseInt(lid);
		}
	}
	</script>
