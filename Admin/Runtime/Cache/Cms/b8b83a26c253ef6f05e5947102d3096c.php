...
<div class="content_table" style="border:1px solid #b8d0d6; padding:10px;">
    ...
    <?php if($is_add == 1): ?><form name="articleForm" action="__APP__/Cms/Article/article_insert" method="post" enctype="multipart/form-data">
    <?php else: ?>
    <form name="articleForm" action="__APP__/Cms/Article/article_update" method="post" enctype="multipart/form-data"><?php endif; ?>
    ...
    <div id="form_content_div" class="form_content">
        ...
        <tr>
        	<td>首页显示：</td>
            <td>
            <?php if($article_info["home_show"] == 1): ?><input type="radio" name="home_show" value="1" checked="checked" />&nbsp;首页显示&nbsp;&nbsp;&nbsp;
            <input type="radio" name="home_show" value="0"  />&nbsp;首页不显示
            <?php else: ?>
            <input type="radio" name="home_show" value="1" />&nbsp;首页显示&nbsp;&nbsp;&nbsp;
            <input type="radio" name="home_show" value="0" checked="checked" />&nbsp;首页不显示<?php endif; ?>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr><td colspan="3">&nbsp;</td></tr>
        <tr>
        	<td>焦点图：</td>
            <td>
            <?php if($article_info["is_focus"] == 1): ?><input type="radio" name="is_focus" value="0" />&nbsp;非焦点图&nbsp;&nbsp;&nbsp;
            <input type="radio" name="is_focus" value="1" checked="checked" />&nbsp;是焦点图
            <?php else: ?>
            <input type="radio" name="is_focus" value="0" checked="checked" />&nbsp;非焦点图&nbsp;&nbsp;&nbsp;
            <input type="radio" name="is_focus" value="1" />&nbsp;是焦点图<?php endif; ?>
            </td>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
        	<td>焦点图片：</td>
            <td><img src="__PUBLIC__/images/focus/<?php echo ($article_info["focus_img"]); ?>" width="200" /></td>
            <td>&nbsp;</td>
		</tr><?php endif; ?>
        <tr><td colspan="3">&nbsp;</td></tr>
        <tr>
