...
<div class="content_table" style="border:1px solid #b8d0d6; padding:10px;">
    ...
    <form name="searchForm" action="__APP__/Cms/Article/article_search" method="post">
    ...
    <tr>
		...
		<?php if(is_array($article_list)): $i = 0; $__LIST__ = $article_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$art): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><a href="__APP__/Cms/Article/article_edit/id/<?php echo ($art["aid"]); ?>">编辑</a>&nbsp;&nbsp;
			<a href="__APP__/Cms/Article/article_delete/id/<?php echo ($art["aid"]); ?>" onclick="return confirm('你确定要删除吗');">删除</a>
			</td>
	...
	<?php if($flag_list == '1'): ?><tr>
        ...
        <?php if($page["page_total"] > 1): ?><a href="__APP__/Cms/Article/article_list/p/1">首页</a>&nbsp;&nbsp;
        <a href="__APP__/Cms/Article/article_list/p/<?php echo ($page["prev_page"]); ?>">前页</a>&nbsp;&nbsp;
        <a href="__APP__/Cms/Article/article_list/p/<?php echo ($page["next_page"]); ?>">后页</a>&nbsp;&nbsp;
        <a href="__APP__/Cms/Article/article_list/p/<?php echo ($page["page_total"]); ?>">尾页</a><?php endif; ?>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	</td>
    </tr>
	<?php else: ?>
	<tr>
    	<td colspan="8" align="right">
        一共<?php echo ($page["total"]); ?>条记录,&nbsp;&nbsp;第<?php echo ($page["p"]); ?>/<?php echo ($page["page_total"]); ?>页&nbsp;&nbsp;
        <?php if($page["page_total"] > 1): ?><a href="__APP__/Cms/Article/article_search/p/1/cid/<?php echo ($cid); ?>/title/<?php echo ($title/option/$option); ?>">首页</a>&nbsp;&nbsp;
        <a href="__APP__/Cms/Article/article_search/p/<?php echo ($page["prev_page"]); ?>/cid/<?php echo ($cid); ?>/title/<?php echo ($title); ?>/option/<?php echo ($option); ?>">前页</a>&nbsp;&nbsp;
        <a href="__APP__/Cms/Article/article_search/p/<?php echo ($page["next_page"]); ?>/cid/<?php echo ($cid); ?>/title/<?php echo ($title); ?>/option/<?php echo ($option); ?>">后页</a>&nbsp;&nbsp;
        <a href="__APP__/Cms/Article/article_search/p/<?php echo ($page["page_total"]); ?>/cid/<?php echo ($cid); ?>/title/<?php echo ($title); ?>/option/<?php echo ($option); ?>">尾页</a><?php endif; ?>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	</td>
    </tr><?php endif; ?>
    </table>
